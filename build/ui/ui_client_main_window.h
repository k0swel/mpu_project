...
"  }"));
        ...
        horizontalLayoutWidget_3->setGeometry(QRect(30, 80, 311, 28));
        ...
        pushButton_solve_equation->setStyleSheet(QString::fromUtf8("QPushButton#pushButton_solve_equation {\n"
"border-radius: 15px;\n"
...
"}\n"
"\n"
"QPushButton#pushButton_solve_equation::hover {\n"
"	border: 2px solid rgb(170, 0, 0);\n"
"}\n"
""));
