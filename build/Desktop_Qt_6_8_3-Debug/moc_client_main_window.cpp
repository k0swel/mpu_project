...
static constexpr auto qt_meta_stringdata_ZN18client_main_windowE = QtMocHelpers::stringData(
    "client_main_window",
...
Q_CONSTINIT static const uint qt_meta_data_ZN18client_main_windowE[] = {
...
Q_CONSTINIT const QMetaObject client_main_window::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN18client_main_windowE.offsetsAndSizes,
    qt_meta_data_ZN18client_main_windowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN18client_main_windowE_t,
        // Q_OBJECT / Q_GADGET
        ...
        // method 'on_pushButton_solve_equation_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void *client_main_window::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN18client_main_windowE.stringdata0))
