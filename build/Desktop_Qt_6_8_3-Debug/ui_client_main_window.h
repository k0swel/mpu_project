...
public:
    ...
    QLabel *label_3;
    QComboBox *comboBox_sign2_quadratic;
...
"  }"));
        ...
        comboBox_sign2_quadratic = new QComboBox(horizontalLayoutWidget_3);
        comboBox_sign2_quadratic->addItem(QString());
        comboBox_sign2_quadratic->addItem(QString());
        comboBox_sign2_quadratic->setObjectName("comboBox_sign2_quadratic");

        Layout_quadratic->addWidget(comboBox_sign2_quadratic);
...
""));
    ...
    void retranslateUi(QWidget *client_main_window)
    {
        ...
        comboBox_sign2_quadratic->setItemText(0, QCoreApplication::translate("client_main_window", "+", nullptr));
        comboBox_sign2_quadratic->setItemText(1, QCoreApplication::translate("client_main_window", "-", nullptr));
